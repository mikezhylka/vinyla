...
// export function handleAddingProductToCart(
//   productQuantity: number,
//   currentProduct: Product,
//   setCartProducts: React.Dispatch<SetStateAction<CartProduct[] | null>>
// ) {
//   setCartProducts(prev => [...prev, { ...currentProduct, quantity: productQuantity }])
// }
